...
<h1><txp:title /></h1>
<img src="<txp:page_url type="theme_path" />/forms/svg/neme_white.svg" alt="NeMe logo" width="40" height="40" class="grid_2 nolarge"/><txp:excerpt />
...
<txp:article_custom limit="999" label="Previously at NAC" venue="NeMe Arts Centre%" section="projects" labeltag="h3" break="li" wraptag="ul" class="submenu noprint" status="live">
<txp:permlink><txp:title /></txp:permlink>
</txp:article_custom>
...
<txp:images category='<txp:category_list type="image" parent="participations" break=","><txp:category type="image" /></txp:category_list>' sort="rand()" limit="1" class="ds"><a href="<txp:site_url />projects/participations/"><txp:thumbnail /></a></txp:images>
</div>
