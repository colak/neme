...
<txp:hide><txp:if_section name="publications"><script type="text/javascript" src="http://books.google.com/books/previewlib.js"></script></txp:if_section>

<script type="text/javascript" src="//widget.battleforthenet.com/widget.min.js" async="async"></script></txp:hide>
...
<div class="line"><h4 class="grid_23 alpha" id="other">Beside the articles appearing in numerous newspapers, magazines and websites showcasing our activities, NeMe and/or IMCA are mentioned in&#8230;</h4><a class="nosmall" href="#<txp:section />"><txp:image id="177" class="grid_1 omega" /></a><div class="clear">&nbsp;</div></div>
...
<txp:hide>==================-neme-to convert to blog-======================
...
<div class="nosmall"><h3>Off line reading</h3>
...
<span class="grid_1 prefix_23 nosmall"><a href="#<txp:if_section name="">front<txp:else /><txp:section /></txp:if_section>"><txp:image id="177" /></a></span>
<div class="clear">&nbsp;</div>
