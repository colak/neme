...
<txp:if_article_list><link rel="stylesheet" media="all" href="<txp:css name="articlelists_2026v3" format="flat.url" />"></txp:if_article_list>
...
<link rel="me" href="https://mastodon.social/@NeMeOrg">
...
<div class="grid_1 nosmall noprint"><a href="#"><img class="margintop" src="<txp:page_url type="theme_path" />/forms/svg/top.svg" width="30" height="30" alt="back to top"></a></div>
<div class="clear">&nbsp;</div>
</div>
