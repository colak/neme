...
<txp:if_description><meta property="og:description" content="<txp:meta_description format="" />"><txp:else /><meta property="og:description" content="<txp:excerpt escape="textile,tags,html" />"></txp:if_description>
<txp:if_article_list>
...
<txp:if_article_list><txp:if_category not><txp:output_form form="YouTubeChannel" /></txp:if_category></txp:if_article_list>
