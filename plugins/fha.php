    ...
    if (isset($year) && $limit > 0) {
        ...
        if (isset($month) && $limit > 0) {
            ...
            if (isset($day) && $limit > 0) {
                ...
                if ($past)
                    $days = ($todayDay > $day) ? ($todayDay - $day) : (date('t', strtotime("$year/$month/$day")) - $day + $todayDay);
                else
                    $days = ($todayDay < $day) ? ($day - $todayDay) : (date('t', strtotime(($month == 1) ? ($year - 1) : (($year) . '/' . (($month == 1) ? (12) : ($month - 1)) . '/' . $day))) - $todayDay + $day);
