...
<div class="embed-container" id="m_<txp:yield name="video" />"><iframe loading="lazy" src="https://www.youtube.com/embed/<txp:yield name="video" />?rel=0" frameborder="0" allowfullscreen></iframe></div>
