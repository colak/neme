...
<p class="red centre"><a rel="nofollow noindex noodp noydir nofollow" href="?accept_vimeo_cookies=yes<txp:if_yield name="id">#<txp:yield name="id" /></txp:if_yield>">View it here</a></p><p>Note that Vimeo only serves First Party cookies for embedded videos in our site, but acording to their <a rel="external noopener" href="https://vimeo.com/cookie_policy">cookie policy</a>, more cookies are used should you wish to view any content in their website.</p>
