...
<div class="embed-container"<txp:if_yield name="id"> id="<txp:yield name="id" />"</txp:if_yield>><iframe loading="lazy" src="https://player.vimeo.com/video/<txp:yield name="video" />" width="640" height="360" frameborder="0" allow="autoplay; fullscreen; gyroscope; accelerometer" allowfullscreen></iframe></div>
<txp:else />
