...
<nav itemscope itemtype="http://schema.org/SiteNavigationElement" class="menu" id="menu-primary" aria-label="Main menu">
...
<div class="wrap">
<ul class="menu-items" id="menu-primary-items" role="menubar">
...
<li role="menuitem"><a href="http://forum.neme.org/" rel="external">Forum</a></li>
