...
<li><a itemprop="url" href="<txp:site_url />blog/"<txp:if_section name="blog"> class="active"</txp:if_section> rel="bookmark">Blog</a></li>
<li><a itemprop="url" href="<txp:site_url />about/subscribe-to-our-newsletter"<txp:if_article_id id="2241"> class="active"</txp:if_article_id> rel="nofollow noopener">Newsletter</a></li>
<li><a itemprop="url" href="<txp:site_url />about/contact-us" <txp:if_article_id id="2240"> class="active" </txp:if_article_id> rel="nofollow noopener">Contact</a></li>
